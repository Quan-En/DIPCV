...
def findFeatures(img):
    ...
    img = cv2.drawKeypoints(img, keypoints, keypoints_with_size, flags = cv2.DRAW_MATCHES_FLAGS_DRAW_RICH_KEYPOINTS)
...
#
def main(img_path1, img_path2, estimation_thresh=0.6):
    ...
    #query image
    img1 = readImage(img_path1)
    #train image
    img2 = readImage(img_path2)
